...
For the Virtual Classroom Client, the URL endpoint that generates the token must be included in the `userConfig` object that is passed to the constructor.
